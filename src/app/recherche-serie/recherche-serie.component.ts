...
@Component({
  selector: 'app-recherche-serie',
  templateUrl: './recherche-serie.component.html',
  styleUrl: './recherche-serie.component.css',
})
export class RechercheSerieComponent {
  searchTerm!: string;
  produits!: Produit[];
  ...
  onKeyUp(filterText: string) {
    this.produits = this.allProduits.filter((item) =>
      item.numeros.includes(filterText)
    );
